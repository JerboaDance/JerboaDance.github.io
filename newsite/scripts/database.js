...
const photographers = {
  jesusChapaMalacara: {
    ...
    bio: `Jesus was born in Monterrey, Mexico, grew up in Kansas City, MO and now lives in a queer feminists’ commune (with cats) in Brooklyn.  He started dancing 5 years ago while a junior in college and has since trained and performed all over the US and in Pakistan and Spain.  Other credits include The Love Show (NYC), Hamza (Islamabad), Dakshina/Daniel Singh (DC).  He has also played the rat king in the Nutcracker: Rated very much G, maybe slightly PG.  Training: Ailey, New Haven Ballet, ADF, Peridance.  Other pursuits include photography, food, writing and political rabble rousing.  He holds a BA in Political Science from Yale.
    `
  }
}
